...
RunAction::RunAction(DetectorConstruction* det, PhysicsList* phys,
 ...
 : G4UserRunAction(),
   ...
   fTallyEdep(new G4double[kMaxTally]), fTallyTrackLen(new G4double[kMaxTally]), fProjRange(0.), fProjRange2(0.),
   fEdeptot(0.), fEniel(0.), fTallyFlux(new G4int[kMaxTally]), fNbPrimarySteps(0), fRange(0)
{ 
