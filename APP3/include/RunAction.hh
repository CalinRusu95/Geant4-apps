...
public:
  ...
  inline void FillFlux(G4int n, G4int a);
  inline void FillEdep(G4double de, G4double eni);
  inline void FillTrack(G4double tr);
  inline void FillTallyTrack(G4int n, G4double trk);
...
private:  
  ...
  G4double*               fTallyEdep;
  G4double*				  fTallyTrackLen;   
  G4int*				  fTallyFlux;
  G4double                fProjRange, fProjRange2;
  G4double                fEdeptot, fEniel, fTrackLen;
...
inline void RunAction::FillTallyTrack(G4int n, G4double trk) 
{
  fTallyTrackLen[n] += trk;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......


inline void RunAction::FillFlux(G4int n, G4int a)
{
	fTallyFlux[n] += a;
}
...
inline void RunAction::FillTrack(G4double tr) 
{
  fTrackLen += tr;
}
